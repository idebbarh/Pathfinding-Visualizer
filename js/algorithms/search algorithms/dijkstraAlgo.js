...
function getNodeWithLowestCoast(openList){
...
//dijkstraAlgo algorithm:
function dijkstraAlgo(startNodePos, targetNodePos, bombAdded,draw){
  let nodeObj = {};
  let openList = [];
  ...
  while(openList.length > 0){
      let curNodeIndex = getNodeWithLowestCoast(openList);
